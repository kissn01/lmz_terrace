...
$(document).ready(function () {
    ...
    var path = '../img/background-part.png';
    $('.daterangepicker').append('<div class="background" style="background-image: url(' + path + '); z-index:-1; height:80px;"><img src="../img/background-part.png" alt="" style="display:none"></div>')
