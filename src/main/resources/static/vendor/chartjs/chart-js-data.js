...
var configareachart = {
    type: 'line',
    data: {
        labels: ['2020-05-17', '2020-05-18', '2020-05-19', '2020-05-20', '2020-05-21', '2020-05-22', '2020-05-23', '2020-05-24', '2020-05-25', '2020-05-26', '2020-05-27', '2020-05-28', '2020-05-29'],
        datasets: [{
            label: '2020-05-17',
            borderWidth: '2',
            borderColor: '#5B92FF',
            backgroundColor: 'rgba(0, 0, 0, 0)',
            data: [100,150,300,480,460,300,500,600,800,1200,1000,1500,1800],
        }, {
            label: '2020-05-18',
            borderWidth: '2',
            borderColor: '#F85778',
            backgroundColor: 'rgba(0, 0, 0, 0)',
            data: [80,150,200,380,460,300,200,600,500,580,800,1200,1600],
        }, {
            label: '2020-05-19',
            borderWidth: '2',
            borderColor: '#1FC96E',
            backgroundColor: 'rgba(0, 0, 0, 0)',
            data: [120,180,320,480,460,200,600,600,900,1200,1400,1500,1900],
        },{
            label: '2020-05-20',
            borderWidth: '2',
            borderColor: '#5B92FF',
            backgroundColor: 'rgba(0, 0, 0, 0)',
            data: [60,150,300,280,460,600,500,300,800,1200,1400,1500,1700],
        }, {
            label: 'My 5 dataset',
            borderWidth: '2',
            borderColor: '#F85778',
            backgroundColor: 'rgba(0, 0, 0, 0)',
            data: [100,120,200,480,160,300,500,900,800,1200,700,1500,2000],
        }, {
            label: 'My 6 dataset',
            borderWidth: '2',
            borderColor: '#1FC96E',
            backgroundColor: 'rgba(0, 0, 0, 0)',
            data: [100,150,100,380,360,600,500,800,900,1200,1080,1500,1800],
        }, {
            label: 'My 7 dataset',
            borderWidth: '2',
            borderColor: '#5B92FF',
            backgroundColor: 'rgba(0, 0, 0, 0)',
            data: [150,180,200,280,460,300,600,900,800,1000,1090,1600,1900],
        }]
    },
    options: {
        responsive: true,
