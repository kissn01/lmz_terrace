...
$(document).ready(function () {
    ...
    if ($.type($.cookie("styleselected")) != 'undefined' && $.cookie("styleselected") != '') {
        ...
        $('head').append('<link href="../css/' + $.cookie("styleselected") + '.css" rel="stylesheet" id="stylelink">');
        setTimeout(function () {
            currentstyle.remove();
        }, 200);

    } else {
        $('head').append('<link href="../css/bootstrap.css" rel="stylesheet" id="stylelink2"><link href="../css/style-darkblue-dark.css" rel="stylesheet" id="stylelink">');
    }
    ...
    $('.style-picker').on('click', function () {
        ...
        $('#stylelink').replaceWith('<link href="../css/' + applystyle + '.css" rel="stylesheet" id="stylelink">');
        setTimeout(function () {
            currentstyle.remove();
            $('.loader').fadeOut('slow');
        }, 1800)
